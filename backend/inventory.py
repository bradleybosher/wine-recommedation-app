...
_WINE_STYLE_KEYWORDS: list[str] = [
    ...
    "cinsault", "cinsaut", "carignan", "counoise", "graciano",
    ...
    "bierzo", "toro", "rueda", "jerez", "sherry", "montilla-moriles",
    # Germany / Austria
...
def filter_wine_list(wine_list_text: str, _profile: TasteProfile | None) -> str:
    ...
    Phase 0: drops floating currency lines and non-wine beverage lines.
    Phase 1: keeps lines with a vintage year, known varietal/region keyword,
             or estate structural word. Food-keyword lines without a vintage are dropped.
    """
